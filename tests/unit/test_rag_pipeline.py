...
class TestRetrievalLogic:
    ...
    @patch("backend.models.rag_pipeline.embedding_model" if False else
           "backend.models.embeddings.embedding_model")
    def test_fallback_returns_top_match_below_threshold(self, mock_emb):
        """If top match is just below threshold, return it via fallback."""
        from backend.config.settings import settings
        # Score below threshold but within delta
